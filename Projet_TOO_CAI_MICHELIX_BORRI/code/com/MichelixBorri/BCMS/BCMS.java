...
public class BCMS extends com.pauware.pauware_engine.Core.AbstractTimer_monitor implements java.net.http.WebSocket.Listener {
// For the sake of simplicity, an embedded database is used...
    ...
    private void init_behavior() throws com.pauware.pauware_engine.Exceptions.State_exception {
        ...
        _BCMS_state_machine = new com.pauware.pauware_engine.Core.StateMachine(_Init.xor(_FSC_connected).xor(_PSC_connected).xor(_Crisis_details_exchange).xor(_Step_3_Coordination).xor(_Step_4_Dispatching).xor(_All_fire_trucks_dispatched).xor(_All_police_vehicles_dispatched).xor(_Step_5_Arrival).xor(_Completion_of_objectives).xor(_End_of_crisis), this.getClass().getSimpleName(), com.pauware.pauware_engine.Core.AbstractStateMachine.Show_on_system_out/*, new com.pauware.pauware2web.PauWare2Web_client()*/);
    }
...
// Error:
    ...
    public String etat(){
        return _BCMS_state_machine.current_state();
    }
}
